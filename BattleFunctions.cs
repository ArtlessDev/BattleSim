public class BattleFunctions{
    ...
    public static int TurnDecider(Monster mon1, Monster mon2){
        ...
        if (mon1.Speed > mon2.Speed){
            ...
            System.Console.WriteLine($"{mon2.Name} will go first");
            return 1; 
        }
    }
    public static int TurnDeciderOpp(Monster mon1, Monster mon2){
        ...
        if (mon1.Speed < mon2.Speed){
            System.Console.WriteLine($"{mon1.Name} will go second");
            return 0;
        }
        else{    
            System.Console.WriteLine($"{mon2.Name} will go second");
            return 1; 
        }
    }
    ...
    public static int ActionDecision(Monster currTurnMon){
        ...
        System.Console.WriteLine($"1. {currTurnMon.MoveOne.Name}\n" +
